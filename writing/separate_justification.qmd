...
And $(\hat{y}^{*(1)}, ..., \hat{y}^{*(2000)})$ would be our posterior predictive distribution under our model for $y^*$, while $(\hat{p}^{(1)}, ..., \hat{p}^{(2000)})$ would be our posterior predictive distribution under our model for $p$.
